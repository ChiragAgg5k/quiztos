...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        " bg-transparent relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg  p-10 md:shadow-xl",
        className,
      )}
      ref={containerRef}
    >
      <div className="bg-transparent flex size-full flex-row items-stretch justify-between gap-10 max-w-lg">
        <div className=" flex flex-col justify-center gap-2">
          ...
          <Circle ref={div4Ref}>
            <SiNextdotjs size={36} color="#000" />
          </Circle>

          <Circle ref={div5Ref}>
            <SiWalletconnect color="blue" size={36} />
          </Circle>
        </div>
